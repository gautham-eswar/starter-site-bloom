  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        <p className="text-draft-text dark:text-gray-300 max-w-2xl mx-auto mb-10 text-lg">
          Join thousands of job seekers who are getting more interviews with DraftZero's resume optimization technology.
        </p>
        <Button
          onClick={() => navigate('/auth')}
          className="bg-draft-green hover:bg-draft-green/90 text-white dark:bg-draft-yellow dark:hover:bg-draft-yellow/90 dark:text-draft-green text-lg px-8 py-6 h-auto rounded-md group transition-all duration-300 transform hover:scale-105"
        >
          Get Started Now
